...
Enter the TDD green phase for the rest of this conversation (or until the user says to move to refactor). Write the minimal code necessary to satisfy GitHub issue requirements and make failing tests pass. Resist the urge to write more than required.
